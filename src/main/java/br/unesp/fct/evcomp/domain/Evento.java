...
public class Evento {
    ...
    public static Evento criarEvento(String titulo, LocalDate dataInicio, LocalDate dataTermino, String descricao, String link, TipoContabilizacao tipo, LocalDate dataInicioInscricao, LocalDate dataFimInscricao) {
        return criarEvento(titulo, dataInicio, dataTermino, descricao, link, tipo, dataInicioInscricao, dataFimInscricao, null);
    }

    public static Evento criarEvento(String titulo, LocalDate dataInicio, LocalDate dataTermino, String descricao, String link, TipoContabilizacao tipo, LocalDate dataInicioInscricao, LocalDate dataFimInscricao, String chavePix) {
